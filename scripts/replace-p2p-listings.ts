...
async function main() {
  ...
  const newListings = [
    ...
    { asset: 'USDT', fiat: 'ETB', side: 'SELL', price: 186.50, amount: 10000, methods: ['CBE'],
      paymentDetails: { 'CBE': { account: '1000031904904', name: 'Melesech' } }, terms: 'Send payment via CBE to 1000031904904 (Melesech), then upload the payment screenshot.' },
    ...
    { asset: 'USDT', fiat: 'ETB', side: 'SELL', price: 185.64, amount: 10000, methods: ['CBE'],
      paymentDetails: { 'CBE': { account: '1000044413217', name: 'Tigist Mekonen' } }, terms: 'Send payment via CBE to 1000044413217 (Tigist Mekonen), then upload the payment screenshot.' },
